...
from env_jv import TicTacToeEnv
...
class Estimator:
    ...
    def __init__(self, env):
        ...
        for _ in range(env.action_space.n):
            ...
            model.partial_fit([self.featurize_state(list(env.reset()[0]))], [0])
...
def q_learning(env, estimator, num_episodes, gamma=1.0, epsilon=0.1, epsilon_decay=1.0, show_every=10):
    """
